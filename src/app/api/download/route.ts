...
/**
 * Proxy route: /api/download?url=<encoded_replicate_url>
 * - Verifies the user is authenticated
 * - Fetches the image from Replicate server-side
 * - Streams it back to the client so the Replicate URL is never exposed
 */
